...
INLINE void host_writew(HostPt off,Bit16u val) {
	host_writeb(off++,(Bit8u)val);val>>=8;
	host_writeb(off,(Bit8u)val);
}
INLINE void host_writed(HostPt off,Bit32u val) {
	host_writeb(off+0,(Bit8u)val);val>>=8;
	host_writeb(off+1,(Bit8u)val);val>>=8;
	host_writeb(off+2,(Bit8u)val);val>>=8;
	host_writeb(off+3,(Bit8u)val);
}
