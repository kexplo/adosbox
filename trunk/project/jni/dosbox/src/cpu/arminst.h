...
#define ADDB(op1,op2,load,save)								\
	...
	asm ("ADDS %[resb], %[var1b], %[var2b] : [resb] "=r" (lf_resb) : [var1b] "r" (lf_var1b), [var2b] "r" (lf_var2b) : "cc" "); \
	save(op1,lf_resb);								\
	lflags.type=t_ADDb;
...
#define SUBB(op1,op2,load,save)								\
	lf_var1b=load(op1);lf_var2b=op2;					\
	/* lf_resb=lf_var1b-lf_var2b; */					\
	asm ("SUBS %[resb], %[var1b], %[var2b] : [resb] "=r" (lf_resb) : [var1b] "r" (lf_var1b), [var2b] "r" (lf_var2b) : "cc" "); \
	save(op1,lf_resb);								\
	lflags.type=t_SUBb;
...
#define ORB(op1,op2,load,save)								\
	lf_var1b=load(op1);lf_var2b=op2;					\
	/* lf_resb=lf_var1b | lf_var2b;	*/			\
	asm ("ORRS %[resb], %[var1b], %[var2b] : [resb] "=r" (lf_resb) : [var1b] "r" (lf_var1b), [var2b] "r" (lf_var2b) : "cc" "); \
	save(op1,lf_resb);								\
	lflags.type=t_ORb;
...
#define XORB(op1,op2,load,save)								\
	lf_var1b=load(op1);lf_var2b=op2;					\
	/* lf_resb=lf_var1b ^ lf_var2b;	*/ \
	asm ("EORS %[resb], %[var1b], %[var2b] : [resb] "=r" (lf_resb) : [var1b] "r" (lf_var1b), [var2b] "r" (lf_var2b) : "cc" "); \			\
	save(op1,lf_resb);								\
	lflags.type=t_XORb;
